...
use Bermuda\Flysystem\OperatorFactory;
...
final class UploadedFileValidator implements UploadedFileValidatorInterface
{
   ...
   /**
    ...
    public function validate(UploadedFileInterface $uploadedFile): void
    {
        ...
        $flysystem = new Flysystem(OperatorFactory::makeLocal($pathInfo['dirname']));
        $fileInfo = $flysystem->open($pathInfo['basename'])->toArray();                       
